...
import com.rnappauth.appauth.browser.BrowserSelector;
import com.rnappauth.appauth.browser.CustomTabManager;
import com.rnappauth.appauth.connectivity.ConnectionBuilder;
import com.rnappauth.appauth.internal.Logger;
...
public class AuthorizationService {
     ...
     * activity is paused or destroyed (i.e. in ).
     */
    public void dispose() {
        if (mDisposed) {
            return;
